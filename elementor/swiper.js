...
var slideTransactionDuration = document.querySelector('div.slide-effect-on') ? 300 : 1;
...
!(function (e, t) {
  ...
  var W = {
    ...
    initialSlide: 0,
    speed: slideTransactionDuration,
    cssMode: !1,
    ...
    longSwipes: !0,
    longSwipesRatio: 0.5,
    longSwipesMs: slideTransactionDuration,
    followFinger: !0,
    allowTouchMove: !0,
    threshold: 0,
      ...
      function T(e) {
        ...
        t.params.cssMode && ((t.wrapperEl.style.overflow = "hidden"), (t.wrapperEl.style.touchAction = "none")),
          ...
          e
            ...
            g > T && (g = T))
            : ((h = 0), (g = 0)),
          m.$imageWrapEl.transition(slideTransactionDuration).transform(`translate3d(${h}px, ${g}px,0)`),
          m.$imageEl.transition(slideTransactionDuration).transform(`translate3d(0,0,0) scale(${s.scale})`);
      }
      function $() {
        const e = t.zoom,
          s = t.params.zoom;
        ...
        (t.params.cssMode && ((t.wrapperEl.style.overflow = ""), (t.wrapperEl.style.touchAction = "")),
          (e.scale = 1),
          (p = 1),
          m.$imageWrapEl.transition(slideTransactionDuration).transform("translate3d(0,0,0)"),
          m.$imageEl.transition(slideTransactionDuration).transform("translate3d(0,0,0) scale(1)"),
      ...
      Object.defineProperty(t.zoom, "scale", {
        ...
        a("touchEnd", (e, s) => {
          ...
          (function () {
            ...
            let s = slideTransactionDuration,
              a = slideTransactionDuration;
            const i = g.x * s,
              r = f.currentX + i,
              n = g.y * a,
              l = f.currentY + n;
                ...
                if (r.freeMode.momentum) {
                  if (d.velocities.length > 1) {
                    const e = d.velocities.pop(),
                      ...
                      i = e.time - s.time;
                    (t.velocity = a / i), (t.velocity /= 2), Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (i > 150 || u() - e.time > slideTransactionDuration) && (t.velocity = 0);
                  } else t.velocity = 0;
